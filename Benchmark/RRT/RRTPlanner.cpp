 ...
 * @brief Constructor
 */
RRTPlanner::RRTPlanner( planning::World &_world, 
 ...
 * @brief Main function
 */
bool RRTPlanner::planPath( int _robotId, 
 ...
 */
bool RRTPlanner::planSingleTreeRrt( int _robotId, 
                                     const Eigen::VectorXi &_links, 
                                     const Eigen::VectorXd &_start, 
                                     const Eigen::VectorXd &_goal, 
                                     bool _connect, 
 ...
 */
bool RRTPlanner::planBidirectionalRrt( int _robotId, 
                                       const Eigen::VectorXi &_links, 
                                       const Eigen::VectorXd &_start, 
                                       const Eigen::VectorXd &_goal, 
                                       bool _connect,
 ...
 */
bool RRTPlanner::checkPathSegment( int _robotId, 
                                   const Eigen::VectorXi &_links, 
 ...
 * @function smoothPath
 */
void RRTPlanner::smoothPath( int _robotId, 
                             const Eigen::VectorXi &_links, 
 ...
 */
void RRTPlanner::smoothPath2( int _robotId, 
                              const Eigen::VectorXi &_links, 
                              std::list<Eigen::VectorXd> &_path ) {
