...
#ifndef _BENCHMARK_TESTS_
#define _BENCHMARK_TESTS_
 ...
 */
class BenchmarkTests : public GRIPTab
{
public:
    ...
    BenchmarkTests(){};
    BenchmarkTests( wxWindow * parent, wxWindowID id = -1,
                    const wxPoint & pos = wxDefaultPosition,
                    const wxSize & size = wxDefaultSize,
                    long style = wxTAB_TRAVERSAL);
    virtual ~BenchmarkTests(){}
    ...
    DECLARE_DYNAMIC_CLASS( BenchmarkTests )
    DECLARE_EVENT_TABLE()
};

#endif /** _BENCHMARK_TESTS_ */
